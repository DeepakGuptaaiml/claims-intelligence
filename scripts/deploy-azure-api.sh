#!/usr/bin/env bash
# Deploy claims reserve FastAPI to Azure Container Apps (API only).
...
APP_NAME="${APP_NAME:-claims-reserve-api}"
IMAGE="${IMAGE:-ghcr.io/deepakguptaaiml/claims-intelligence:latest}"
